...
- [ ] Remote error & log handler
- [ ] Monitoring component
   - [ ] Monitor systemctl services
   - [ ] Monitor websites (status & response time)
   - [ ] Async command monitor loop (check all services)
   - [ ] Report offline status with email alert
