...
## TODOS
- [ ] visitors stats (charts: country, city, visitors by date)
- [ ] current online visitor counter
- [ ] admin-panel div height calcularor 100% - nav panel
- [ ] better user system
- [ ] chat (owner & admin name = red)
- [ ] chat command system
- [ ] Terminal in admin
