...
/**
 * Class EmailSendServiceManagerController
 *
 * Controller for handling email sending in the admin panel.
 *
 * @package App\Controller\Admin
 */
class EmailSendServiceManagerController extends AbstractController
{
    ...
    public function sendEmail(Request $request): Response
    {
        ...
        return $this->render('admin/email-send-manager.html.twig', [
            // user data
