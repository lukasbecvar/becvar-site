<form class="loginFormPosY loginForm" action="?admin=login&action=register" method="post">
    <h2 class="loginFormTitle">Register admin account</h2>
    ...
    <div class="rightPosition" style="margin-right: 3px;"><input class="inputButton" type="submit" name="submitRegister" value="Register"></div>
</form>