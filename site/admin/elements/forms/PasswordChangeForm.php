<form class="loginForm" style="top: 56%;" action="?admin=accountSettings" method="post">
    ...
    <div class="rightPosition"><input class="inputButton" type="submit" name="submitPasswordChange" value="Submit"></div>
</form>