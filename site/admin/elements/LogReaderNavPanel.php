<ul class="breadcrumb"> 
    <li>
        <a class="selectorButton btn-small" href="?admin=dbBrowser&name=logs&limit=<?php echo $config->getValue("rowInTableLimit"); ?>&startby=0"><strong>Unfiltered browser</strong></a>
    </li>  
