...
<?php //The account settings component in admin site
    ...
    include($_SERVER['DOCUMENT_ROOT'].'/../site/components/elements/admin/forms/ProfilePicChnageForm.php');


    //Include password change form
    include($_SERVER['DOCUMENT_ROOT'].'/../site/components/elements/admin/forms/PasswordChangeForm.php');
?>
</div>
