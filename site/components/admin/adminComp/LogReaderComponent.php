...
<?php //Log reader [admin component]
	...
	if (!$adminController->isUserOwner()) {
        ...
        //include navbar
        include($_SERVER['DOCUMENT_ROOT'].'/../site/components/elements/admin/LogReaderNavPanel.php');
        ...
        if (empty($_GET["action"])) {
            ...
            include($_SERVER['DOCUMENT_ROOT'].'/../site/components/elements/admin/LogReaderInfoBox.php');
            ...
            if ($action == "deleteLogs") {
                ...
                //Include conf box
                include($_SERVER['DOCUMENT_ROOT'].'/../site/components/elements/admin/forms/LogDeleteConfirmationBox.php');
